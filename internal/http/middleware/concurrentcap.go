...
// ConcurrentCap returns a Gin middleware that limits the number
...
// Example usage:
//
//	router.Use(ConcurrentCap(100)) // allow up to 100 concurrent requests
func ConcurrentCap(maxConcurrent int) gin.HandlerFunc {
